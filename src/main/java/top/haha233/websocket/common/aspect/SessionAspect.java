package top.haha233.websocket.common.aspect;

import com.google.gson.Gson;
import top.haha233.websocket.common.annotation.NeedRole;
import top.haha233.websocket.common.enumeration.UserRoleEnum;
...
public class SessionAspect {
     ...
     */
    @Around("@annotation(top.haha233.websocket.common.annotation.NeedLogin)")
     ...
     * @throws Throwable 发生异常时抛出
     */
    @Around("@annotation(top.haha233.websocket.common.annotation.NeedRole)")
     ...
     * @throws Throwable 发生异常时抛出
     */
    @Around("@annotation(top.haha233.websocket.common.annotation.GetUserInfo)")
